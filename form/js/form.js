...
var $lastTr = $("tr:last");
$(".add").click(function(){
	$lastTr.before("<tr><td></td>" + $(this).parent().prev().clone()[0].outerHTML() + "<td></td></tr>");
});
//正则表达式
//Regular Expression
//RegExp
...
//匹配身份证号码，不计润平年
console.log("332521196902060091".test(/^((1[1-5]|2[1-3]|3[1-7]|4[1-6]|5[0-4]|6[1-5]|71|8[12])\d|8(86|5[23]))\d{3}(19\d{2}|20(0\d|1[0-6]))((0[13578]|1[02])(0[1-9]|[12]\d|3[01])|(0[469]|11)(0[1-9]|[12]\d|30)|02(0[1-9]|[12]\d))\d{3}[\dxX]$/));